...
describe('helpers/get-start-and-end-time-of-date', () => {
  ...
  it('should return the startTime and endTime of provided date', () => {
    ...
    const expectedStartTime = new Date(today.setHours(START_TIME_LIMIT_HOURS, START_TIME_LIMIT_MINUTES, START_TIME_LIMIT_SECONDS, START_TIME_LIMIT_MS));
    const expectedEndTime = new Date(today.setHours(END_TIME_LIMIT_HOURS, END_TIME_LIMIT_MINUTES, END_TIME_LIMIT_SECONDS, END_TIME_LIMIT_MS));
