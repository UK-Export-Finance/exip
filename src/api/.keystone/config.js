...
var mapEligibility = (application2) => {
  ...
  const mapped = [
    ...
    xlsx_row_default(
      String(FIELDS4[MORE_THAN_250K2.VALUE]),
      map_yes_no_field_default({ answer: eligibility[TOTAL_CONTRACT_VALUE_FIELD_ID2].valueId === MORE_THAN_250K2.DB_ID }),
    ),
...
var mapPreviousCoverWithBuyer = (application2) => {
  ...
  if (totalContractValueOverThreshold) {
    ...
    if (answer === true) {
      mapped.push(
        xlsx_row_default(String(FIELDS23[PREVIOUS_CREDIT_INSURANCE_COVER_WITH_BUYER3]), buyerRelationship[PREVIOUS_CREDIT_INSURANCE_COVER_WITH_BUYER3]),
      );
    }
    return mapped;
  }
