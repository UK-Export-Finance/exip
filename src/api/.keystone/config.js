...
var canApplyForInsuranceOnline = (cisCountry) => {
  ...
  const conditions = esra_classification_is_standard_high_or_very_high_default(ESRAClassificationDesc) && has_valid_short_term_cover_default(shortTermCoverAvailabilityDesc) && country_rating_is_a_or_b_default(countryRatingDesc);
  return conditions;
};
