...
var { WILL_ADHERE_TO_ALL_REQUIREMENTS, HAS_NO_OFFENSES_OR_INVESTIGATIONS, IS_NOT_AWARE_OF_EXISTING_SLAVERY } = declarations_default2.LATEST_MODERN_SLAVERY_DECLARATIONS;
...
var getPolicyById = async (context, id) => {
  try {
    ...
    const policy = await context.query.Policy.findOne({
      where: { id },
      query: "id policyType requestedStartDate contractCompletionDate requestedCreditLimit totalValueOfContract creditPeriodWithBuyer policyCurrencyCode totalMonthsOfCover totalSalesToBuyer maximumBuyerWillOwe needPreCreditPeriodCover jointlyInsuredParty { id companyName companyNumber countryCode requested }"
    });
    return policy;
  } catch (error) {
...
var {
  DECLARATIONS: {
    ...
    MODERN_SLAVERY: { WILL_ADHERE_TO_ALL_REQUIREMENTS: WILL_ADHERE_TO_ALL_REQUIREMENTS2, HAS_NO_OFFENSES_OR_INVESTIGATIONS: HAS_NO_OFFENSES_OR_INVESTIGATIONS2, IS_NOT_AWARE_OF_EXISTING_SLAVERY: IS_NOT_AWARE_OF_EXISTING_SLAVERY2 },
...
var DECLARATIONS_FIELDS = {
  ...
  MODERN_SLAVERY: {
    [WILL_ADHERE_TO_ALL_REQUIREMENTS2]: {
      LABEL: "Do you adhere to, and intend to continue to adhere to, all requirements that apply to you as set out in the Modern Slavery Act 2015, including reporting obligations, and all applicable legislation relating to the prevention of modern slavery in every country that you operate in?",
      SUMMARY: {
    ...
    [HAS_NO_OFFENSES_OR_INVESTIGATIONS2]: {
      LABEL: "Do you confirm you are not currently under investigation and have not been fined, convicted or found guilty of any offences under the Modern Slavery Act 2015, or under any applicable similar laws or regulations relating to the prevention of modern slavery or any similar infringement of human rights in any jurisdiction?",
      SUMMARY: {
        TITLE: "Does the user confirm they are not under investigation or has been convicted of any human right violations"
      },
      CONDITIONAL_REASON: {
        LABEL: "Provide full details. Include all information relating to the type of Modern Slavery that exists or has existed, and/or any investigation or enforcement action, and any actions taken by you in connection with this.",
        MAXIMUM: MAXIMUM_CHARACTERS.DECLARATIONS.MODERN_SLAVERY.CONDITIONAL_REASON,
        SUMMARY: {
    ...
    [IS_NOT_AWARE_OF_EXISTING_SLAVERY2]: {
      LABEL: "To the best of your knowledge, can you confirm you are not aware of the existence of Modern Slavery in respect of yourself, the export contract(s), your immediate holding company or your supply chain, in each case, at present or in the past 2 years.",
      SUMMARY: {
...
var LINKS = {
  EXTERNAL: {
    ...
    NBI_FORM: "https://assets.publishing.service.gov.uk/government/uploads/system/uploads/attachment_data/file/618316/export-insurance-non-binding-indication-request-form_20170609.pdf",
    ...
    OHCHR_UN_GUIDING_PRINCIPLES_ON_BUSINESS_AND_HUMAN_RIGHTS: "https://www.ohchr.org/en/publications/reference-publications/guiding-principles-business-and-human-rights",
...
var {
  ...
  EXPORTER_BUSINESS: {
    ...
    YOUR_COMPANY: { HAS_DIFFERENT_TRADING_NAME: HAS_DIFFERENT_TRADING_NAME2, DIFFERENT_TRADING_NAME, PHONE_NUMBER: PHONE_NUMBER2, HAS_DIFFERENT_TRADING_ADDRESS: HAS_DIFFERENT_TRADING_ADDRESS2, WEBSITE: WEBSITE2 }
  },
  POLICY: {
...
var mapEligibility = (application2) => {
  ...
  let mapped = [
    ...
    xlsx_row_default(ELIGIBILITY_FIELDS[HAS_COMPANIES_HOUSE_NUMBER2].SUMMARY?.TITLE, map_yes_no_field_default({ answer: eligibility[HAS_COMPANIES_HOUSE_NUMBER2] })),
...
var mapNameOnPolicy = (policyContact) => {
  ...
  if (policyContact[IS_SAME_AS_OWNER]) {
    ...
    mapped = [xlsx_row_default(String(FIELDS6.NAME_ON_POLICY[NAME2]), nameOnPolicy), xlsx_row_default(String(FIELDS6.NAME_ON_POLICY[POSITION2]), policyContact[POSITION2])];
    return mapped;
  }
  mapped = [
...
var mapBroker = (application2) => {
  ...
  if (broker[USING_BROKER3]) {
    mapped = [...mapped, xlsx_row_default(String(FIELDS12[BROKER_NAME2]), broker[BROKER_NAME2]), xlsx_row_default(String(FIELDS12[EMAIL8]), broker[EMAIL8]), map_broker_address_default(broker)];
  }
  return mapped;
};
...
var {
  ...
  YOUR_COMPANY: { HAS_DIFFERENT_TRADING_NAME: HAS_DIFFERENT_TRADING_NAME4, HAS_DIFFERENT_TRADING_ADDRESS: HAS_DIFFERENT_TRADING_ADDRESS3, PHONE_NUMBER: PHONE_NUMBER3, WEBSITE: WEBSITE3 },
...
var {
  MODERN_SLAVERY: { WILL_ADHERE_TO_ALL_REQUIREMENTS: WILL_ADHERE_TO_ALL_REQUIREMENTS4, HAS_NO_OFFENSES_OR_INVESTIGATIONS: HAS_NO_OFFENSES_OR_INVESTIGATIONS4, IS_NOT_AWARE_OF_EXISTING_SLAVERY: IS_NOT_AWARE_OF_EXISTING_SLAVERY4 }
} = declarations_default;
...
var mapModernSlaveryFields = (modernSlavery) => {
  const mapped = [
    xlsx_row_default(WILL_ADHERE_TO_ALL_REQUIREMENTS_STRINGS.SUMMARY.TITLE, map_yes_no_field_default({ answer: modernSlavery[WILL_ADHERE_TO_ALL_REQUIREMENTS4] })),
    map_cannot_adhere_conditional_reason_default(modernSlavery),
    xlsx_row_default(HAS_NO_OFFENSES_OR_INVESTIGATIONS_STRINGS.SUMMARY.TITLE, map_yes_no_field_default({ answer: modernSlavery[HAS_NO_OFFENSES_OR_INVESTIGATIONS4] })),
    map_offenses_conditional_reason_default(modernSlavery),
    xlsx_row_default(IS_NOT_AWARE_OF_EXISTING_SLAVERY_STRINGS.SUMMARY.TITLE, map_yes_no_field_default({ answer: modernSlavery[IS_NOT_AWARE_OF_EXISTING_SLAVERY4] })),
...
var { EXPORTER_BUSINESS: EXPORTER_BUSINESS4, POLICY: POLICY5, BUYER: BUYER2, EXPORT_CONTRACT: EXPORT_CONTRACT3, DECLARATIONS: DECLARATIONS4 } = SECTION_NAMES_default;
...
var hasNoSupport = ({ countryRating, esraClassification, shortTermCover }) => {
  ...
  const countryRatingConditions = country_rating_is_a_or_b_default(countryRating) || country_rating_is_c_or_d_default(countryRating) || countryRatingIsNotApplicable;
...
var canGetAQuoteOnline = (cisCountry) => {
  ...
  const conditions = esra_classification_is_standard_high_or_very_high_default(ESRAClassificationDesc) && short_term_cover_is_yes_refer_or_unlisted_default(shortTermCoverAvailabilityDesc) && country_rating_is_a_or_b_default(countryRatingDesc);
  return conditions;
};
