...
var mapDeclarations = (application2) => {
  ...
  const mapped = [
    xlsx_row_default(SECTION_TITLES3.DECLARATIONS, ""),
    ...
    xlsx_row_default(String(FIELDS11[HAS_ANTI_BRIBERY_CODE_OF_CONDUCT3]), map_yes_no_field_default(declaration[HAS_ANTI_BRIBERY_CODE_OF_CONDUCT3])),
    xlsx_row_default(String(FIELDS11[WILL_EXPORT_WITH_CODE_OF_CONDUCT3]), map_yes_no_field_default(declaration[WILL_EXPORT_WITH_CODE_OF_CONDUCT3])),
    xlsx_row_default(String(FIELDS11[AGREE_HOW_YOUR_DATA_WILL_BE_USED3]), map_agreed_field_default(declaration[AGREE_HOW_YOUR_DATA_WILL_BE_USED3])),
