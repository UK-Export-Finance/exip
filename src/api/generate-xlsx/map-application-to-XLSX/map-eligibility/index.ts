...
const mapEligibility = (application: Application) => {
  ...
  const mapped = [
    ...
    xlsxRow(CONTENT_STRINGS[WANT_COVER_OVER_MAX_AMOUNT].SUMMARY?.TITLE, mapYesNoField(eligibility[TOTAL_CONTRACT_VALUE_ELIGIBILITY].valueId === MORE_THAN_500K.DB_ID)),
