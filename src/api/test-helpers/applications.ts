...
const applicationQuery =
  'id createdAt updatedAt referenceNumber dealType submissionCount submissionDeadline submissionType status previousStatus version eligibility { id } policy { id } exportContract { id } owner { id } company { id } business { id } broker { id } buyer { id } sectionReview { id } declaration { id } policyContact { id }';
