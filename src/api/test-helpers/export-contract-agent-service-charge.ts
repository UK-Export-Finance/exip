...
const create = async (context: Context, data = {}) => {
  try {
    ...
    console.error('Error getting a exportContractAgentServiceCharge (test helpers)');
...
const get = async (context: Context, chargeId: string) => {
  try {
    ...
    console.error('Error getting a exportContractAgentServiceCharge by ID (test helpers)');
