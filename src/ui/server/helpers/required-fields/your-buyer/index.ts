...
const { CONNECTION_TO_THE_BUYER_DESCRIPTION, CONNECTED_WITH_BUYER, TRADED_WITH_BUYER } = YOUR_BUYER_FIELD_IDS.WORKING_WITH_BUYER;
/**
 * getYourCompanyTasks
...
export const workingWithBuyerTasks = (connectedWithBuyer?: boolean): Array<string> => {
  if (connectedWithBuyer) {
    return [CONNECTION_TO_THE_BUYER_DESCRIPTION, CONNECTED_WITH_BUYER, TRADED_WITH_BUYER];
  }

  return [CONNECTED_WITH_BUYER, TRADED_WITH_BUYER];
};
