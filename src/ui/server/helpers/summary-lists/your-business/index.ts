...
import { ApplicationExporterCompany, ApplicationBusiness, ApplicationExporterBroker, SummaryListItemData } from '../../../../types';
 ...
 * @param {ApplicationBusiness} answersBusiness Application exporterCompany object
...
const yourBusinessSummaryList = (
  ...
  const fields = generateFields(answersExporterCompany, answersBusiness, answersExporterBroker, referenceNumber, checkAndChange);
