...
const { OUTSTANDING_PAYMENTS, FAILED_PAYMENTS, TOTAL_OUTSTANDING, AMOUNT_OVERDUE } = YOUR_BUYER_FIELD_IDS;

export const FIELD_IDS = [OUTSTANDING_PAYMENTS, FAILED_PAYMENTS, TOTAL_OUTSTANDING, AMOUNT_OVERDUE];
