...
const { TRADING_WITH_BUYER_SAVE_AND_BACK, CHECK_YOUR_ANSWERS } = YOUR_BUYER_ROUTES;
...
export const pageVariables = (referenceNumber: number) => ({
  FIELD_ID,
  SAVE_AND_BACK_URL: `${INSURANCE_ROOT}/${referenceNumber}${TRADING_WITH_BUYER_SAVE_AND_BACK}`,
  horizontalRadios: true,
});

export const TEMPLATE = TEMPLATES.SHARED_PAGES.SINGLE_RADIO_PAGE;
