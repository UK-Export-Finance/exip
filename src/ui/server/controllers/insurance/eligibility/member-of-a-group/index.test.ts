...
const { MEMBER_OF_A_GROUP_EXIT, CHECK_YOUR_ANSWERS } = INSURANCE_ROUTES.ELIGIBILITY;
...
describe('controllers/insurance/eligibility/member-of-a-group', () => {
  ...
  describe('FIELD_ID', () => {
    it('should have the correct ID', () => {
      const expected = FIELD_IDS.INSURANCE.ELIGIBILITY.IS_MEMBER_OF_A_GROUP;
  ...
  describe('post', () => {
    ...
    describe('when submitted answer is true', () => {
      ...
      it(`should redirect to ${MEMBER_OF_A_GROUP_EXIT}`, () => {
        ...
        expect(res.redirect).toHaveBeenCalledWith(MEMBER_OF_A_GROUP_EXIT);
      });
    });
