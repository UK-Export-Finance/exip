...
describe('controllers/insurance/eligibility/letter-of-credit', () => {
  ...
  describe('FIELD_ID', () => {
    it('should have the correct ID', () => {
      const expected = FIELD_IDS.INSURANCE.ELIGIBILITY.LETTER_OF_CREDIT;
  ...
  describe('TEMPLATE', () => {
    it('should have the correct template defined', () => {
      expect(TEMPLATE).toEqual(TEMPLATES.INSURANCE.ELIGIBILITY.LETTER_OF_CREDIT);
    });
  });
  ...
  describe('post', () => {
    ...
    describe('when submitted answer is true', () => {
      ...
      it('should add exitReason to req.flash', async () => {
        ...
        const expectedReason = PAGES.INSURANCE.APPLY_OFFLINE.REASON.WILL_BE_PAID_BY_LETTER_OF_CREDIT;
