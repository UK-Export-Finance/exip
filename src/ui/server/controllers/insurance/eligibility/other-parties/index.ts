...
export const FIELD_ID = FIELD_IDS.INSURANCE.ELIGIBILITY.OTHER_PARTIES_INVOLVED;
...
export const TEMPLATE = TEMPLATES.INSURANCE.ELIGIBILITY.OTHER_PARTIES_INVOLVED;
