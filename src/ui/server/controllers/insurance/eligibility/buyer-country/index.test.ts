...
describe('controllers/insurance/eligibility/buyer-country', () => {
  ...
  describe('getBackLink', () => {
    ...
    describe('when the referer is `insurance eligibility - check if you are eligible`', () => {
      it('should return the referer', () => {
        const result = getBackLink(ROUTES.INSURANCE.ELIGIBILITY.CHECK_IF_ELIGIBLE);

        const expected = ROUTES.INSURANCE.ELIGIBILITY.CHECK_IF_ELIGIBLE;
        expect(result).toEqual(expected);
      });
    });
