...
const {
  ...
  ELIGIBILITY: { CANNOT_APPLY_EXIT: CANNOT_APPLY_ROUTE, TOTAL_VALUE_INSURED, CHECK_YOUR_ANSWERS, TALK_TO_AN_EXPORT_FINANCE_MANAGER },
} = INSURANCE_ROUTES;
...
export const post = async (req: Request, res: Response) => {
  try {
     ...
     * redirect to TALK_TO_AN_EXPORT_FINANCE_MANAGER.
     */
    ...
    if (noShortTermCover) {
      ...
      return res.redirect(TALK_TO_AN_EXPORT_FINANCE_MANAGER);
    }
