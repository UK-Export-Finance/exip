...
import { mockCompany, mockBusiness, mockExporterBroker } from '../../../../test-mocks/mock-application';
...
describe('controllers/insurance/business/check-your-answers', () => {
  ...
  describe('get', () => {
    it('should render template', async () => {
      await get(req, res);
      const summaryList = yourBusinessSummaryList(mockCompany, mockBusiness, mockExporterBroker, mockApplication.referenceNumber);
