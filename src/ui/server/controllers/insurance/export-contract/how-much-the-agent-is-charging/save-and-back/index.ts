...
/**
 * post
 * Save any valid "How much the agent is charging" form fields and if successful, redirect to the all sections page
...
export const post = async (req: Request, res: ResponseInsurance) => {
  try {
    ...
    console.error('Error updating application - export contract - how much the agent is charging (save and back) %o', error);
