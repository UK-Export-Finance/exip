...
/**
 * post
 * Save any valid "Declined by private market" form fields and if successful, redirect to the all sections page
...
export const post = async (req: Request, res: Response) => {
  try {
    ...
    console.error('Error updating application - export contract - declined by private market (save and back) %o', error);
