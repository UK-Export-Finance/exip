...
const {
  AGENT_CHARGES: { METHOD, FIXED_SUM, FIXED_SUM_AMOUNT, PERCENTAGE },
} = FIELD_IDS;

const {
  AGENT_CHARGES: { [METHOD]: METHOD_ERROR_MESSAGES, [PERCENTAGE]: PERCENTAGE_ERROR_MESSAGES, [FIXED_SUM_AMOUNT]: FIXED_SUM_AMOUNT_ERROR_MESSAGES },
...
const method = (formBody: RequestBody, errors: object) => {
  ...
  if (formBody[METHOD] === PERCENTAGE) {
    return percentageNumberValidation(formBody, PERCENTAGE, errors, PERCENTAGE_ERROR_MESSAGES);
  }
