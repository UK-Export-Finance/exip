        ...
        TABLE: {
          ...
          BODY: [
            ...
            EXPANDABLE.TABLE.BODY[1],
            {
              TERM: 'Corrupt Activity',
              DEFINITION: [
                'Means any activity with reference to a person (including without limitation the offering of any payment, reward or other advantage to any public official or other person), which is',
                '(a) found by a court in a competent jurisdiction (after all available rights of appeal have been exhausted) to have rendered the export contract illegal, void, voidable or unenforceable under its governing law;',
                'or',
                '(b) other than under duress, has been admitted by that person (which shall include, for the avoidance of doubt, admissions of activity made under a deferred prosecution agreement in England, civil forfeiture order or similar administrative settlement in another jurisdiction);',
                'or',
                '(c) is found by a court or competent authority in any competent jurisdiction (after all available rights of appeal have been exhausted) outside the United Kingdom to constitute an offence under any applicable law (except by virtue of changes to that law having retrospective effect);',
                'or',
                '(d) is found by a court or competent authority in the United Kingdom (after all available rights of appeal have been exhausted) to constitute a Relevant Offence and which activity in respect of paragraphs (a), (b) and (c) above corresponds to a Relevant Offence provided that, where for the purposes of paragraph (b) above, any such activity is admitted by an Excluded Person, such activity shall not, for the purposes of this policy, constitute “Corrupt Activity” if such activity was not, at the time it was engaged in, unlawful under the laws or regulations of the country in which it took place;',
              ],
            },
            EXPANDABLE.TABLE.BODY[3],
            {
              ...
              DEFINITION: [
                'Means',
                '(a) where such activity is engaged in prior to 1 July 2011, (i) a person other than a national of the United Kingdom (as defined in s.109(4) of the Anti-terrorism, Crime and Security Act 2001); or (ii) a body incorporated under the laws of a country other than the United Kingdom;',
                'and',
                '(b) where such activity is engaged in on or after that date, a person or body of a type not listed in s.12(4) of the Bribery Act 2010;',
              ],
            },
            EXPANDABLE.TABLE.BODY[5],
            {
              TERM: 'Involved Group Company',
              DEFINITION: [
                'Means a Group Company which (a) having made the reasonable enquiries referred to in paragraph 8(ii) above, has had, or is intended to have, at the date of this Proposal, any material part in the negotiation or obtaining of the export contract.',
              ],
            },
