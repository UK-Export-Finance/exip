...
const APPLICATION_SUBMITTED = {
  ...
  WHAT_HAPPENS_NEXT: {
    ...
    CLIMATE_CHANGE_FACTORS:
      'We also take climate change factors into an account before deciding if we can offer export insurance for your business. We may contact you with extra questions if we need to assess the environmental impact of your exports.',
  },
  DECISION_FROM_US: {
