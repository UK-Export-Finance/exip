...
const {
  ...
  CHECK_YOUR_ANSWERS: {
    ELIGIBILITY: CHECK_YOUR_ANSWERS_APPLICATION_ELIGIBILITY,
    START_NEW_APPLICATION: CHECK_YOUR_ANSWERS_APPLICATION_START_NEW_APPLICATION,
  ...
  describe('RELEVANT_ROUTES', () => {
    it('should return an array of routes', () => {
      const expected = [
        ...
        YOUR_BUYER.ROOT,
        DECLARATIONS.ROOT,
        CHECK_YOUR_ANSWERS_APPLICATION_ELIGIBILITY,
        CHECK_YOUR_ANSWERS_APPLICATION_START_NEW_APPLICATION,
