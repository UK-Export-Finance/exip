...
export const generateRequiredData = (): RequiredDataStateInsuranceEligibility => {
  ...
  requiredData[MEMBER_OF_A_GROUP] = [...requiredData[PARTY_TO_CONSORTIUM], PARTY_TO_CONSORTIUM_FIELD_ID];
  requiredData[MEMBER_OF_A_GROUP_CHANGE] = [...requiredData[PARTY_TO_CONSORTIUM], PARTY_TO_CONSORTIUM_FIELD_ID];

  requiredData[CHECK_YOUR_ANSWERS] = [...requiredData[MEMBER_OF_A_GROUP], MEMBER_OF_A_GROUP_FIELD_ID];
