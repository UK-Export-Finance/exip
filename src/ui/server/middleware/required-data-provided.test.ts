  ...
  describe('allRequiredData', () => {
    describe('when policy type is single', () => {
      it('should return an array of all required fields with single policy specific fields', () => {
        ...
        const expected = {
          [BUYER_COUNTRY]: [],
          [COMPANY_BASED]: [FIELD_IDS.BUYER_COUNTRY],
          [HAS_MINIMUM_UK_GOODS_OR_SERVICES]: [FIELD_IDS.BUYER_COUNTRY, FIELD_IDS.VALID_COMPANY_BASE],
          [POLICY_TYPE]: [FIELD_IDS.BUYER_COUNTRY, FIELD_IDS.VALID_COMPANY_BASE],
          [TELL_US_ABOUT_YOUR_POLICY]: [FIELD_IDS.BUYER_COUNTRY, FIELD_IDS.VALID_COMPANY_BASE, FIELD_IDS.POLICY_TYPE, FIELD_IDS.POLICY_LENGTH],
          [CHECK_YOUR_ANSWERS]: [
