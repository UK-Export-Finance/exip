const COMPANIES_HOUSE_EXIT_PAGE = 'insurance/eligibility/companies-house-exit.njk';
...
export const ELIGIBILITY_TEMPLATES = {
  ...
  NO_COMPANIES_HOUSE_NUMBER_EXIT: COMPANIES_HOUSE_EXIT_PAGE,
  COMPANIES_HOUSE_SEARCH: 'insurance/eligibility/companies-house-search.njk',
  COMPANIES_HOUSE_UNAVAILABLE_EXIT: 'insurance/eligibility/companies-house-unavailable.njk',
  COMPANY_NOT_ACTIVE_EXIT: COMPANIES_HOUSE_EXIT_PAGE,
