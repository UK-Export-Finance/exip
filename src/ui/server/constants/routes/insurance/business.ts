...
const COMPANIES_HOUSE_NUMBER_ROOT = `${ROOT}/companies-house-number`;
...
export const EXPORTER_BUSINESS = {
  ...
  COMPANIES_HOUSE_NUMBER_SAVE_AND_BACK: `${COMPANIES_HOUSE_NUMBER_ROOT}/save-and-back`,
  COMPANIES_HOUSE_NUMBER_CHANGE: `${COMPANIES_HOUSE_NUMBER_ROOT}/change`,
  NO_COMPANIES_HOUSE_NUMBER: `${COMPANIES_HOUSE_NUMBER_ROOT}/no-companies-house-number`,
  ...
  CONTACT_ROOT,
  CONTACT_CHANGE: `${CONTACT_ROOT}/change`,
  CONTACT_CHECK_AND_CHANGE: `${CONTACT_ROOT}/check-and-change`,
  CONTACT_SAVE_AND_BACK: `${CONTACT_ROOT}/save-and-back`,
