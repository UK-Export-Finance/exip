...
export const EXPORTER_BUSINESS = {
  ...
  TURNOVER_ALTERNATIVE_CURRENCY: `${TURNOVER_ROOT}/alternative-currency`,
  TURNOVER_ALTERNATIVE_CURRENCY_CHANGE: `${TURNOVER_ROOT}/alternative-currency/change`,
  TURNOVER_ALTERNATIVE_CURRENCY_CHECK_AND_CHANGE: `${TURNOVER_ROOT}/alternative-currency/check-and-change`,
