...
export const INSURANCE_ROUTES = {
  ...
  ELIGIBILITY: {
    ...
    CANNOT_APPLY_EXIT: `${INSURANCE_ROOT}${ELIGIBILITY_ROOT}/cannot-apply`,
    ...
    NO_COMPANIES_HOUSE_NUMBER_EXIT: `${INSURANCE_ROOT}${ELIGIBILITY_ROOT}/no-companies-house-number`,
    ...
    COMPANIES_HOUSE_UNAVAILABLE_EXIT: `${INSURANCE_ROOT}${ELIGIBILITY_ROOT}/companies-house-unavailable`,
    COMPANY_NOT_ACTIVE_EXIT: `${INSURANCE_ROOT}${ELIGIBILITY_ROOT}/company-not-active`,
    ...
    LONG_TERM_COVER_EXIT: `${INSURANCE_ROOT}${ELIGIBILITY_ROOT}/long-term-cover`,
    ...
    CANNOT_APPLY_MULTIPLE_RISKS_EXIT: `${INSURANCE_ROOT}${ELIGIBILITY_ROOT}/multiple-risks`,
    ...
    TALK_TO_AN_EXPORT_FINANCE_MANAGER: `${INSURANCE_ROOT}${ELIGIBILITY_ROOT}/contract-too-short`,
