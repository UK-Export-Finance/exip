...
const LOSS_PAYEE_ROUTES = {
  ...
  LOSS_PAYEE_FINANCIAL_DETAILS_UK_SAVE_AND_BACK: `${LOSS_PAYEE_FINANCIAL_DETAILS_UK_ROOT}/save-and-back`,
  LOSS_PAYEE_FINANCIAL_DETAILS_UK_CHANGE: `${LOSS_PAYEE_FINANCIAL_DETAILS_UK_ROOT}/change`,
  LOSS_PAYEE_FINANCIAL_DETAILS_UK_CHECK_AND_CHANGE: `${LOSS_PAYEE_FINANCIAL_DETAILS_UK_ROOT}/check-and-change`,
  LOSS_PAYEE_FINANCIAL_DETAILS_INTERNATIONAL_ROOT,
  LOSS_PAYEE_FINANCIAL_DETAILS_INTERNATIONAL_SAVE_AND_BACK: `${LOSS_PAYEE_FINANCIAL_DETAILS_INTERNATIONAL_ROOT}/save-and-back`,
  LOSS_PAYEE_FINANCIAL_DETAILS_INTERNATIONAL_CHANGE: `${LOSS_PAYEE_FINANCIAL_DETAILS_INTERNATIONAL_ROOT}/change`,
  LOSS_PAYEE_FINANCIAL_DETAILS_INTERNATIONAL_CHECK_AND_CHANGE: `${LOSS_PAYEE_FINANCIAL_DETAILS_INTERNATIONAL_ROOT}/check-and-change`,
};
