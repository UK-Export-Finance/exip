export const QUOTE_ROUTES = {
  ...
  HAS_MINIMUM_UK_GOODS_OR_SERVICES: '/quote/uk-goods-services',
  HAS_MINIMUM_UK_GOODS_OR_SERVICES_CHANGE: '/quote/uk-goods-services/change',

  POLICY_TYPE: '/quote/kind-of-policy',
  POLICY_TYPE_CHANGE: '/quote/kind-of-policy/change',

  TELL_US_ABOUT_YOUR_POLICY: '/quote/tell-us-about-policy',
  TELL_US_ABOUT_YOUR_POLICY_CHANGE: '/quote/tell-us-about-policy/change',
