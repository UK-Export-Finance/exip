        ...
        !(function (e, n) {
          ...
          !(function () {
            ...
            function Z(t, e, n, o) {
              ...
              if (!o && (ut(e), (e = e || u), d)) {
                ...
                if (!(T[t + ' '] || (p && p.test(t)))) {
                  if (((f = t), (h = e), 1 === y && (I.test(t) || O.test(t)))) {
                    for (
            ...
            function ut(t) {
              ...
              return o != u && 9 === o.nodeType && o.documentElement
                ? ((l = (u = o).documentElement),
                  ...
                  L != u && (n = u.defaultView) && n.top !== n && n.addEventListener('unload', Q),
                    ...
                    return 1 === o && 0 === r
                      ...
                      : function (e, n, u) {
                          ...
                          if (m) {
                            if (i) {
                              for (; h; ) {
                                for (d = e; (d = d[h]); ) if (s ? E(d, g) : 1 === d.nodeType) return !1;
                            ...
                            if (((f = [a ? m.firstChild : m.lastChild]), a && b)) {
                              ...
                              for (
                                ;
                                (d = (++p && d && d[h]) || (x = p = 0) || f.pop()) &&
                                (!(s ? E(d, g) : 1 === d.nodeType) || !++x || (b && ((c = d[v] || (d[v] = {}))[t] = [y, x]), d !== e));
          ...
          (j.filter = function (t, e, n) {
            ...
            j.fn.extend({
              ...
              is: function (t) {
                return !!I(this, 'string' == typeof t && R.test(t) ? j(t) : t || [], !1).length;
              },
            });
          var P,
            W = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
            ...
            j.each(
              {
                ...
                contents: function (t) {
                  return null != t.contentDocument && a(t.contentDocument)
                    ? t.contentDocument
                    : (E(t, 'template') && (t = t.content || t), j.merge([], t.childNodes));
                },
              },
              function (t, e) {
                j.fn[t] = function (n, o) {
          ...
          function Mt(t, e, n, o, r) {
            ...
            for (d.textContent = '', f = 0; (i = p[f++]); )
              ...
              else if (((l = gt(i)), (a = _t(d.appendChild(i), 'script')), l && Bt(a), n)) for (c = 0; (i = a[c++]); ) Et.test(i.type || '') && n.push(i);
            return d;
          }
          var $t = /^([^.]*)(?:\.(.+)|)/;
          function Ft() {
          ...
          (j.event = {
            ...
            special: {
              ...
              click: {
                setup: function (t) {
                  var e = this || t;
                  return jt.test(e.type) && e.click && E(e, 'input') && Ht(e, 'click', !0), !1;
                },
                trigger: function (t) {
                  var e = this || t;
                  return jt.test(e.type) && e.click && E(e, 'input') && Ht(e, 'click'), !0;
                },
                _default: function (t) {
                  var e = t.target;
                  return (jt.test(e.type) && e.click && E(e, 'input') && st.get(e, 'click')) || E(e, 'a');
                },
              },
              beforeunload: {
          ...
          var qt = /<script|<style|<link/i,
            ...
            Ot = /^\s*<!\[CDATA\[|\]\]>\s*$/g;
          function It(t, e) {
            return (E(t, 'table') && E(11 !== e.nodeType ? e : e.firstChild, 'tr') && j(t).children('tbody')[0]) || t;
          }
          function Pt(t) {
          ...
          function Vt(t, e, n, o) {
            ...
            if (p && ((i = (r = Mt(e, t[0].ownerDocument, !1, t, o)).firstChild), 1 === r.childNodes.length && (r = i), i || o)) {
              for (s = (a = j.map(_t(r, 'script'), Pt)).length; d < p; d++)
              ...
              html: function (t) {
                return tt(
                  ...
                  function (t) {
                    ...
                    if ('string' == typeof t && !qt.test(t) && !At[(St.exec(t) || ['', ''])[1].toLowerCase()]) {
                      t = j.htmlPrefilter(t);
                      try {
              ...
              ajax: function (t, e) {
                ...
                f.hasContent
                  ...
                  : ((p = f.url.slice(r.length)),
                    ...
                    !1 === f.cache && ((r = r.replace(Ie, '$1')), (p = (De.test(r) ? '&' : '?') + '_=' + Be.guid++ + p)),
                    (f.url = r + p)),
                f.ifModified &&
