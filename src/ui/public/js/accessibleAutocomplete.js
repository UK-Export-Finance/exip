...
!(function () {
          ...
          (t = function () {
            return (function (e) {
              ...
              function (e, t, n) {
                  ...
                  if (!e._disable) {
                    ...
                    if (
                      ...
                      if ('function' == typeof D) {
                        var F = m(i);
                        (u = _) && u.constructor === D && F.key == u.__key
                          ? A(u, F, 1, p, !1)
                          : ((P = u),
                            (e._component = u = I(D, F, p)),
                      ...
                      if (g && T !== g && u !== _) {
                        var L = g.parentNode;
                        L && T !== L && (L.replaceChild(T, g), P || ((g._component = null), E(g, !1)));
                      }
                      if ((P && j(P), (e.base = T) && !r)) {
                        for (var B = e, R = e; (R = R._parentComponent); ) (B = R).base = T;
                        (T._component = B), (T._componentConstructor = B.constructor);
                      }
                    }
                    for (
                ...
                var F = { h: a, createElement: a, cloneElement: c, Component: T, render: D, rerender: h, options: o };
                t.default = F;
              },
              function (e, t) {
                  ...
                  return (
                    ...
                    (n.render = function () {
                      var e,
                        ...
                        T = 0 !== M.length,
                        D = M.length >= s,
                        F = this.props.showNoOptionsFound && k && j && T && D,
                        L = i + '__wrapper',
                        B = i + '__input',
                        R = null !== O ? ' ' + B + '--focused' : '',
                        U = this.props.showAllValues ? ' ' + B + '--show-all-values' : ' ' + B + '--default',
                        V = i + '__dropdown-arrow-down',
                        q = -1 !== O && null !== O,
                        W = i + '__menu',
                        H = W + '--' + u,
                        K = W + '--' + (S || F ? 'visible' : 'hidden'),
                        Q = i + '__option',
                        z = i + '__hint',
                        G = this.templateInputValue(E[N]),
                        $ = G && 0 === G.toLowerCase().indexOf(M.toLowerCase()) && A ? M + G.substr(M.length) : '',
                        J = l + '__assistiveHint',
                      ...
                      return (
                        ...
                        (0, r.createElement)(
                          ...
                          $ && (0, r.createElement)('span', null, (0, r.createElement)('input', { className: z, readonly: !0, tabIndex: '-1', value: $ })),
                          (0, r.createElement)(
                            'input',
                            a(
                              {
                          ...
                          (0, r.createElement)(
                            ...
                            F && (0, r.createElement)('li', { className: Q + ' ' + Q + '--no-results' }, v()),
                          ),
  ...
  !(function () {
    ...
    var e = n(221),
      t = n.n(e);
    r.default = void (window.accessibleAutocomplete = t());
  })(),
    ((DTFS = void 0 === DTFS ? {} : DTFS).accessibleAutocomplete = r);
})();
