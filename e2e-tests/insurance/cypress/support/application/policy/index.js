...
Cypress.Commands.add('completeSingleContractPolicyForm', require('../../../../../commands/insurance/complete-single-contract-policy-form'));
...
Cypress.Commands.add(
  ...
  require('../../../../../commands/insurance/complete-and-submit-multiple-contract-policy-form'),
);
...
Cypress.Commands.add(
  ...
  require('../../../../../commands/insurance/complete-and-submit-different-name-on-policy-form'),
);
...
Cypress.Commands.add('completeBrokerManualAddressForm', require('../../../../../commands/insurance/complete-broker-manual-address-form'));
Cypress.Commands.add('completeAndSubmitBrokerManualAddressForm', require('../../../../../commands/insurance/complete-and-submit-broker-manual-address-form'));
...
Cypress.Commands.add(
  ...
  require('../../../../../commands/insurance/complete-and-submit-loss-payee-financial-details-uk-form'),
);
Cypress.Commands.add(
  'completeLossPayeeFinancialDetailsInternationalForm',
  require('../../../../../commands/insurance/complete-loss-payee-financial-details-international-form'),
);
Cypress.Commands.add(
  'completeAndSubmitLossPayeeFinancialDetailsInternationalForm',
  require('../../../../../commands/insurance/complete-and-submit-loss-payee-financial-details-international-form'),
);
Cypress.Commands.add(
  'completeAndSubmitAllLossPayeeFormsViaChangeYourAnswers',
  require('../../../../../commands/insurance/complete-and-submit-all-loss-payee-forms-via-change-your-answers'),
);
...
Cypress.Commands.add(
  ...
  require('../../../../../commands/insurance/change-policy-type-to-multiple-and-submit-contract-policy-form'),
);
Cypress.Commands.add(
  'changePolicyTypeToSingleAndSubmitContractPolicyForm',
  require('../../../../../commands/insurance/change-policy-type-to-single-and-submit-contract-policy-form'),
);

Cypress.Commands.add(
  'completePrepareApplicationSinglePolicyType',
  require('../../../../../commands/insurance/complete-prepare-application-section-single-policy-type'),
);
Cypress.Commands.add(
