Cypress.Commands.add('completeCompanyOrOrganisationForm', require('../../../../../commands/insurance/your-buyer/complete-company-or-organisation-form'));
Cypress.Commands.add(
  'completeAndSubmitCompanyOrOrganisationForm',
  require('../../../../../commands/insurance/your-buyer/complete-and-submit-company-or-organisation-form'),
);
Cypress.Commands.add(
  'completeAndSubmitConnectionWithTheBuyerForm',
  require('../../../../../commands/insurance/your-buyer/complete-and-submit-connection-with-the-buyer-form'),
);
Cypress.Commands.add('completeConnectionWithTheBuyerForm', require('../../../../../commands/insurance/your-buyer/complete-connection-with-the-buyer-form'));
Cypress.Commands.add(
  'completeAndSubmitTradedWithBuyerForm',
  require('../../../../../commands/insurance/your-buyer/complete-and-submit-traded-with-buyer-form'),
);
...
Cypress.Commands.add(
  ...
  require('../../../../../commands/insurance/your-buyer/complete-and-submit-credit-insurance-cover-form'),
);
Cypress.Commands.add(
  'completeAndSubmitBuyerFinancialInformationForm',
  require('../../../../../commands/insurance/your-buyer/complete-and-submit-buyer-financial-information-form'),
);
Cypress.Commands.add(
