...
Cypress.Commands.add(
  ...
  require('../../../../commands/insurance/account/complete-and-submit-sign-in-account-form-maximum-invalid-retries'),
);
...
Cypress.Commands.add(
  ...
  require('../../../../commands/insurance/account/complete-and-submit-password-reset-form-maximum-retries'),
);
Cypress.Commands.add(
  'completeAndSubmitNewPasswordAccountForm',
  require('../../../../commands/insurance/account/complete-and-submit-new-password-account-form'),
);
