...
context(
  'Insurance - Policy - Change your answers - Broker address - Not based in UK to Based in UK - Single address available - Enter address manually - As an exporter, I want to change my answers to the broker section',
  () => {
    let referenceNumber;
