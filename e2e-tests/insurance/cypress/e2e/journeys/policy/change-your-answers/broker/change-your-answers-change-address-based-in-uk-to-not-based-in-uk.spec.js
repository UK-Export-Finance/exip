...
context(
  'Insurance - Policy - Change your answers - Broker address - Based in UK to not Not based in UK - As an exporter, I want to change my answers to the broker section',
  () => {
    let referenceNumber;
    ...
    describe('when clicking the `change` link', () => {
      it(`should redirect to ${BROKER_CONFIRM_ADDRESS_CHANGE}`, () => {
        ...
        cy.assertChangeAnswersPageUrl({ referenceNumber, route: BROKER_CONFIRM_ADDRESS_CHANGE, fieldId: FIELD_ID });
      });
    });
    ...
    describe('after changing the answer from no to yes and completing (now required) broker fields', () => {
      ...
      it(`should redirect to ${CHECK_YOUR_ANSWERS}`, () => {
        ...
        cy.completeAndSubmitBrokerDetailsForm({ usingBroker: false, isBasedInUk: false });
