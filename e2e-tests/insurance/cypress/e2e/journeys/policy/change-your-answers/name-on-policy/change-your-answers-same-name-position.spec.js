...
context(
  `Insurance - Policy - Change your answers - Policy contact - Same name - ${POSITION} - As an exporter, I want to change my answers to the same name on policy as policy owner`,
  () => {
    let referenceNumber;
    let url;
