...
const {
  POLICY: { CHECK_YOUR_ANSWERS, NAME_ON_POLICY_CHANGE },
} = INSURANCE_ROUTES;
...
context(
  'Insurance - Policy - Change your answers - Policy contact - As an exporter, I want to change my answers from different name to the same name on policy as policy owner',
  () => {
    let referenceNumber;
    let url;
