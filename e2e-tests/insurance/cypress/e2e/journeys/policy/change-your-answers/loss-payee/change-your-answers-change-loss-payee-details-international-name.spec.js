...
const {
  ROOT,
  POLICY: { LOSS_PAYEE_DETAILS_CHANGE, LOSS_PAYEE_FINANCIAL_DETAILS_INTERNATIONAL_CHANGE, CHECK_YOUR_ANSWERS },
} = INSURANCE_ROUTES;
...
context(
  `Insurance - Policy - Change your answers - Loss payee details - International - ${NAME} - As an exporter, I want to change my answers to the loss payee section`,
  () => {
    let referenceNumber;
