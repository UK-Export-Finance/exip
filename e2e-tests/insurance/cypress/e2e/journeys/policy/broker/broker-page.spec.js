...
const { USING_BROKER: FIELD_ID } = POLICY_FIELD_IDS;

const {
  ROOT,
  POLICY: { BROKER_ROOT, BROKER_DETAILS_ROOT, LOSS_PAYEE_ROOT, ANOTHER_COMPANY },
} = INSURANCE_ROUTES;
...
context(
  'Insurance - Policy - Broker page - As an Exporter I want to confirm if I am using a broker for my export Insurance so that UKEF and I can easily collaborate and manage correspondence regarding my credit insurance',
  () => {
    let referenceNumber;
    let url;
    let lossPayeeUrl;
