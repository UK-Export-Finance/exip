...
context(
  'Insurance - Export contract - About goods or services page - Final destination known - As an exporter, I want to enter the details of the export contract',
  () => {
    let referenceNumber;
    let url;
    ...
    describe('form submission', () => {
      it(`should redirect to ${HOW_WILL_YOU_GET_PAID}`, () => {
        ...
        cy.completeAndSubmitAboutGoodsOrServicesForm({ finalDestinationKnown: true });
