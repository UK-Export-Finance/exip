...
import { privateMarketWhyDescription } from '../../../../../../partials';
...
context(
  'Insurance - Export contract - Private market page - As an exporter, I want to state whether I tried to get insurance through the private market previously, So that UKEF can ensure it is complementing rather than competing with the private market',
  () => {
    let referenceNumber;
    let url;
