...
context(
  'Insurance - Export contract - Start page - As an Exporter, I want to provide details on my export contract, So that UKEF can have clarity on the export contract',
  () => {
    let referenceNumber;
