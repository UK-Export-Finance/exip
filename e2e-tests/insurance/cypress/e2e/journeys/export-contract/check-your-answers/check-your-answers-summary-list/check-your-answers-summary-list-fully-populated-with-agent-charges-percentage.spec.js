...
context(
  'Insurance - Export contract - Check your answers - Summary list - application over total contract value threshold, private insurance attempt, using an agent, agent is charging - percentage method',
  () => {
    let referenceNumber;
    let url;
