...
const {
  ROOT,
  EXPORT_CONTRACT: { CHECK_YOUR_ANSWERS, PRIVATE_MARKET_CHANGE, DECLINED_BY_PRIVATE_MARKET_CHANGE },
} = INSURANCE_ROUTES;
...
context(
  'Insurance - Export contract - Change your answers - Private market - No to yes - As an exporter, I want to check my answers for the questions concerning my goods/services, So that I ensure I am sending the right details regarding the product or service I am exporting',
  () => {
    let referenceNumber;
