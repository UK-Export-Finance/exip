...
const {
  ROOT,
  EXPORT_CONTRACT: { CHECK_YOUR_ANSWERS, AGENT_CHANGE, AGENT_DETAILS_CHANGE, AGENT_SERVICE_CHANGE },
} = INSURANCE_ROUTES;
...
context(
  'Insurance - Export contract - Change your answers - Agent - No to yes - As an Exporter, I want to be able to review my input regarding whether an agent helped me win the export contract, So that I can be assured I am providing UKEF with the right information',
  () => {
    let referenceNumber;
