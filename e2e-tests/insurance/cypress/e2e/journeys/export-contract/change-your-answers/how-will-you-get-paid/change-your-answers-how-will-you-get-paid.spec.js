...
const {
  ROOT,
  EXPORT_CONTRACT: { CHECK_YOUR_ANSWERS, HOW_WILL_YOU_GET_PAID_CHANGE },
} = INSURANCE_ROUTES;
...
context(
  'Insurance - Export contract - Change your answers - How you will get paid - As an exporter, I want to check my answers for the questions concerning how I will get paid for my export',
  () => {
    let referenceNumber;
    let url;
