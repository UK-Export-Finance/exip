import { field as fieldSelector, headingCaption, noRadio, noRadioInput, yesNoRadioHint, yesRadio } from '../../../../../../pages/shared';
...
const {
  ROOT,
  EXPORT_CONTRACT: { HOW_WILL_YOU_GET_PAID, AGENT, AGENT_DETAILS, CHECK_YOUR_ANSWERS },
} = INSURANCE_ROUTES;
...
context(
  'Insurance - Export contract - Agent page - As an Exporter, I want to state whether another party helped me win my export contract, So that I can provide underwriters with all required pre-requisite information as part of my application',
  () => {
    let referenceNumber;
    let url;
    let agentDetailsUrl;
