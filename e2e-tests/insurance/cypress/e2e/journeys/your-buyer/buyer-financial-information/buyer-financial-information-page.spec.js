...
const {
  YOUR_BUYER: { BUYER_FINANCIAL_INFORMATION, CHECK_YOUR_ANSWERS, TRADED_WITH_BUYER },
} = ROUTES.INSURANCE;
...
context(
  'Insurance - Your buyer - Buyer financial information - As an exporter, I want to provide the details on the buyer of my export trade, So that UKEF can gain clarity on the buyer history as part of due diligence',
  () => {
    let referenceNumber;
    let url;
    ...
    before(() => {
      cy.completeSignInAndGoToApplication({}).then(({ referenceNumber: refNumber }) => {
        ...
        cy.completeUpToSpecifiedYourBuyerSectionAnswers({ section: 'tradedWithBuyer' });
