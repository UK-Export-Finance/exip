...
context('Insurance - Your Buyer - Company or organisation page - form validation - company or organisation name', () => {
  ...
  describe(`when ${FIELD_ID} is over ${MAXIMUM_CHARACTERS.BUYER_COMPANY_OR_ORGANISATION} characters`, () => {
    it('should display validation errors and retain the submitted value', () => {
      const submittedValue = 'a'.repeat(MAXIMUM_CHARACTERS.BUYER_COMPANY_OR_ORGANISATION + 1);
