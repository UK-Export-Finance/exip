...
const {
  ROOT,
  YOUR_BUYER: { CONNECTION_WITH_BUYER, CONNECTION_WITH_BUYER_CHANGE, CHECK_YOUR_ANSWERS },
} = INSURANCE_ROUTES;
...
context(
  `Insurance - Your buyer - Change your answers - Working with buyer - ${CONNECTION_WITH_BUYER} - Yes to no - As an exporter, I want to change my answers to the working with buyer section`,
  () => {
    let url;
    ...
    before(() => {
      cy.completeSignInAndGoToApplication({ totalContractValueOverThreshold: true }).then(({ referenceNumber: refNumber }) => {
        ...
        cy.completeUpToSpecifiedYourBuyerSectionAnswers({ section: 'buyerFinancialInformation', hasConnectionToBuyer: true });
