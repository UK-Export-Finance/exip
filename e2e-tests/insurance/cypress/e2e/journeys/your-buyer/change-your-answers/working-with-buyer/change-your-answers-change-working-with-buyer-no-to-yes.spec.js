...
context(
  `Insurance - Your buyer - Change your answers - Working with buyer - ${FIELD_ID} - No to yes - As an exporter, I want to change my answers to the working with buyer section`,
  () => {
    let url;
    let referenceNumber;
    let fieldVariables;
