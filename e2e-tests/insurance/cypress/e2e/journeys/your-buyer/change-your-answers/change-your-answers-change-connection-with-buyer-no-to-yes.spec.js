...
context(`Insurance - Your buyer - Change your answers - Connection with buyer - ${FIELD_ID} - No to yes - As an exporter, I want to change my answers to the connection with buyer section`, () => {
  let referenceNumber;
