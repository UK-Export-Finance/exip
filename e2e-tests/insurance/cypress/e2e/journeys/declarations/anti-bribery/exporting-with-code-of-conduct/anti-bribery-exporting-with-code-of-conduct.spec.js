...
context(
  "Insurance - Declarations - Anti-bribery - Exporting with code of conduct page - As an Exporter, I want to confirm if I will use my company's anti - bribery code of conduct for my credit insurance application, So that UKEF can refer to it as applicable when processing my credit insurance application",
  () => {
    let referenceNumber;
    let url;
    ...
    before(() => {
      cy.completeSignInAndGoToApplication({}).then(({ referenceNumber: refNumber }) => {
        ...
        cy.completeAndSubmitDeclarationsForms({ formToStopAt: 'codeOfConduct', referenceNumber, completeCheckYourAnswers: true });
