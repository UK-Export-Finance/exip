...
const {
  ROOT: INSURANCE_ROOT,
  DECLARATIONS: { CONFIRMATION_AND_ACKNOWLEDGEMENTS, HOW_YOUR_DATA_WILL_BE_USED },
...
context(
  'Insurance - Declarations - How your data will be used page - As an Exporter, I want to have details of how my credit insurance application data will be used, So that I can determine if I am okay with the use of my application in that format',
  () => {
    let referenceNumber;
    let url;
    ...
    describe('page tests', () => {
      ...
      describe('latest confidentiality content', () => {
        ...
        const { paragraph, link } = howYourDataWillBeUsedPage;
