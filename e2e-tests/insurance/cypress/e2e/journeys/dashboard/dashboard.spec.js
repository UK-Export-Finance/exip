...
context(
  'Insurance - Dashboard - new application - As an Exporter, I want to access my UKEF credit insurance application from my dashboard, So that I can easily complete my application',
  () => {
    let referenceNumber;
