...
const {
  COMPANIES_HOUSE: { COMPANY_SIC, INDUSTRY_SECTOR_NAME },
} = INSURANCE_FIELD_IDS;

const baseUrl = Cypress.config('baseUrl');

context(
  'Insurance - Eligibility - Companies details page - company with multiple SIC codes - I want to check if I can use online service to apply for UKEF Export Insurance Policy',
  () => {
