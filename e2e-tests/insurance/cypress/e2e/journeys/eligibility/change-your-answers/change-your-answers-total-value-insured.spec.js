...
context(
  'Insurance - Eligibility - Change your answers - Total contract value - As an exporter, I want to change my answers to the eligibility total contract value section',
  () => {
