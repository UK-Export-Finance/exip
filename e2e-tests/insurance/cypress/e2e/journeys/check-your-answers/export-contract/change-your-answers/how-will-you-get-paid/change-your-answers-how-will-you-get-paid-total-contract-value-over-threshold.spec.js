...
const {
  ...
  EXPORT_CONTRACT: { HOW_WILL_YOU_GET_PAID_CHECK_AND_CHANGE, PRIVATE_MARKET_CHECK_AND_CHANGE },
} = INSURANCE_ROUTES;
...
context('Insurance - Change your answers - Export contract - Summary list - How will you get paid - With total contract value over threshold', () => {
  let referenceNumber;
  let url;
