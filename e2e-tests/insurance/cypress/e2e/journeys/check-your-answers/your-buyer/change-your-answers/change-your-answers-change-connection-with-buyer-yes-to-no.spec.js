...
context(
  `Insurance - Check your answers - Your buyer - Connection with buyer - ${FIELD_ID} - Yes to no - As an exporter, I want to change my answers to the connection with buyer section`,
  () => {
    let referenceNumber;
