...
const {
  ...
  YOUR_BUYER: { BUYER_FINANCIAL_INFORMATION_CHECK_AND_CHANGE },
} = INSURANCE_ROUTES;
...
context(
  'Insurance - Check your answers - Your buyer - Buyer financial accounts - As an exporter, I want to change my answers to the buyer financial accounts section',
  () => {
    let referenceNumber;
    let url;
