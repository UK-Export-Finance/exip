...
const {
  ...
  POLICY: { BROKER_ADDRESSES_CHECK_AND_CHANGE, BROKER_CONFIRM_ADDRESS_CHECK_AND_CHANGE, BROKER_MANUAL_ADDRESS_CHECK_AND_CHANGE },
} = INSURANCE_ROUTES;

const baseUrl = Cypress.config('baseUrl');

context(
  'Insurance - Change your answers - Policy - Broker - Broker address - Not based in UK to Based in UK - Multiple addresses available - Enter address manually - As an exporter, I want to change my answers to the broker section',
  () => {
    let referenceNumber;
