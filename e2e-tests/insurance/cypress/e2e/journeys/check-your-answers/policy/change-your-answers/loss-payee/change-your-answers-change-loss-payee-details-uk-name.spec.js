...
const {
  ROOT,
  POLICY: { LOSS_PAYEE_DETAILS_CHECK_AND_CHANGE, LOSS_PAYEE_FINANCIAL_DETAILS_UK_CHECK_AND_CHANGE },
...
context(
  `Insurance - Change your answers - Policy - Loss payee details - UK - ${NAME} - As an exporter, I want to change my answers to the loss payee section`,
  () => {
    let referenceNumber;
    ...
    describe('form submission with a new answer', () => {
      ...
      it(`should redirect to ${LOSS_PAYEE_FINANCIAL_DETAILS_UK_CHECK_AND_CHANGE} and then ${TYPE_OF_POLICY}`, () => {
        summaryList.field(fieldId).changeLink().click();
