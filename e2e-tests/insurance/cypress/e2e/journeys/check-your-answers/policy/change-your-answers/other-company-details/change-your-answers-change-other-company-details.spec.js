...
context(
  'Insurance - Change your answers - Policy - Other company details - As an exporter, As an exporter, I want to change my answers to the other company details section',
  () => {
    let referenceNumber;
