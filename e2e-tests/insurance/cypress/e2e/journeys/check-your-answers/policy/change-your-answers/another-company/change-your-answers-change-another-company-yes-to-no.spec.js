...
context(
  'Insurance - Change your answers - Policy - Another company - Yes to no - As an exporter, As an exporter, I want to change my answers to the other company details section',
  () => {
    let referenceNumber;
