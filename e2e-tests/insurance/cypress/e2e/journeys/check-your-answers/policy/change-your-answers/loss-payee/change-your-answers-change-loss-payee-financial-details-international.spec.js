...
context(
  'Insurance - Change your answers - Policy - Loss payee details - Financial details - International - As an exporter, I want to change my answers to the loss payee section',
  () => {
    let referenceNumber;
