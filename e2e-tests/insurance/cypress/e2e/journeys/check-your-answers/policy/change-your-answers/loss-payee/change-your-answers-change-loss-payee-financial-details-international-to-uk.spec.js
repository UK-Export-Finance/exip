...
context(
  'Insurance - Change your answers - Policy - Loss payee details - Financial details - International to UK - As an exporter, I want to change my answers to the loss payee section',
  () => {
    let referenceNumber;
