...
const {
  ROOT,
  EXPORTER_BUSINESS: { COMPANY_DETAILS_CHANGE, ALTERNATIVE_TRADING_ADDRESS_ROOT, CHECK_YOUR_ANSWERS },
} = INSURANCE_ROUTES;

const baseUrl = Cypress.config('baseUrl');

context(
  `Insurance - Your business - Change your answers - Company details - ${FIELD_ID} - Yes to no - As an exporter, I want to change my answers to the company details section`,
  () => {
    let referenceNumber;
    let url;
