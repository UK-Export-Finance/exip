...
context(
  'Insurance - Your business - Start page - As an Exporter, I want to provide details about my business, So that I can provide necessary business information to support my application for Export Insurance',
  () => {
    let referenceNumber;
