...
context(
  'Insurance - Account - Sign out - As an Exporter, I want to be able to sign out of the service from any of the digital service pages, So that I can readily maintain the security of my digital service account',
  () => {
    let referenceNumber;
