...
const {
  ACCOUNT: { ACCESS_CODE, PASSWORD },
} = INSURANCE_FIELD_IDS;

const baseUrl = Cypress.config('baseUrl');

context(
  'Insurance - Account - Password reset and sign in - As an Exporter, I want to login to my UKEF digital service account after my password reset, So that I can securely access my digital service account with UKEF',
  () => {
