...
context(
  'Insurance - Account - Sign in - As an Exporter, I want to sign in into my UKEF digital service account after completing eligibility, So that I can complete my application for a UKEF Export Insurance Policy',
  () => {
    let url;
    ...
    describe('page tests', () => {
      ...
      it('renders a `reset password` link', () => {
        ...
        cy.checkLink(signInPage.resetPasswordLink(), expectedHref, expectedText);
      });
      ...
      it('renders a `need to create an account` copy and button link', () => {
        ...
        cy.checkLink(signInPage.createAccountLink(), expectedHref, expectedText);
      });
