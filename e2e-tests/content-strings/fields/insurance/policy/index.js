import {
  APPLICATION, ELIGIBILITY, FIELD_VALUES, MAXIMUM_CHARACTERS,
} from '../../../../constants';
...
const {
  ...
  POLICY: {
    ...
    LOSS_PAYEE_DETAILS: {
      NAME: LOSS_PAYEE_NAME, LOCATION, IS_LOCATED_IN_UK, IS_LOCATED_INTERNATIONALLY,
    },
  ...
  REQUESTED_JOINTLY_INSURED_PARTY: {
    [REQUESTED]: {
      ...
      SUMMARY: {
        ...
        FORM_TITLE: POLICY_FORM_TITLES.OTHER_COMPANY,
      },
    },
    [COMPANY_NAME]: {
