...
export const END_BUYERS_DESCRIPTION = {
  ...
  LIST_INTRO: 'Goods or services that need to be sold on before an exporter can be paid carries extra risk. If your buyer is reliant on an end buyer, it means that we would have to cover two risks:',
  LIST: [
    'your buyer not paying you',
    'your buyer not being paid by their end buyer',
  ],
  OUTRO: {
