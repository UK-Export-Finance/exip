...
const {
  INSURANCE: {
    ...
    YOUR_BUYER: {
      COMPANY_OR_ORGANISATION: { ADDRESS, COUNTRY, NAME: COMPANY_OR_ORGANISATION_NAME, REGISTRATION_NUMBER, WEBSITE },
...
const application = {
  ELIGIBILITY: {
    buyerCountryIsoCode: COUNTRY_APPLICATION_SUPPORT.ONLINE_SUPPORT.ISO_CODE,
  ...
  [BUYER_COUNTRY]: COUNTRY_APPLICATION_SUPPORT.ONLINE_SUPPORT.NAME,
  ...
  REQUESTED_JOINTLY_INSURED_PARTY: {
    ...
    [COUNTRY_CODE]: COUNTRY_APPLICATION_SUPPORT.ONLINE_SUPPORT.NAME,
  ...
  EXPORT_CONTRACT: {
    ...
    [FINAL_DESTINATION]: COUNTRY_APPLICATION_SUPPORT.ONLINE_SUPPORT.ISO_CODE,
    ...
    AGENT_DETAILS: {
      ...
      [AGENT_COUNTRY_CODE]: COUNTRY_APPLICATION_SUPPORT.ONLINE_SUPPORT.NAME,
    ...
    AGENT_CHARGES: {
      ...
      [PAYABLE_COUNTRY_CODE]: COUNTRY_APPLICATION_SUPPORT.ONLINE_SUPPORT.NAME,
    },
  },
  EXPORTER_BUSINESS: {
    ...
    [TURNOVER_CURRENCY_CODE]: GBP_CURRENCY_CODE,
  },
  BROKER: {
    [USING_BROKER]: true,
  ...
  BUYER: {
    ...
    [COUNTRY]: COUNTRY_APPLICATION_SUPPORT.ONLINE_SUPPORT.NAME,
