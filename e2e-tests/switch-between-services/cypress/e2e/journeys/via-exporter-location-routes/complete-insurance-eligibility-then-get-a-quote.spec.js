...
const {
  INSURANCE: {
    ELIGIBILITY: { EXPORTER_LOCATION, COMPANIES_HOUSE_NUMBER },
  },
  QUOTE,
} = ROUTES;
...
context(
  'Complete insurance eligibility, get a quote and then re-visit the insurance eligibility - all by visiting the buyer country form instead of via `start now` route',
  () => {
    before(() => {
