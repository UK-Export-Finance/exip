...
context('Tried to obtain private cover page', () => {
  ...
  it('renders yes and no radio buttons', () => {
    const yesRadio = triedToObtainCoverPage[CONSTANTS.FIELDS.TRIED_PRIVATE_COVER].yes();
    ...
    const noRadio = triedToObtainCoverPage[CONSTANTS.FIELDS.TRIED_PRIVATE_COVER].no();
  ...
  describe('form submission', () => {
    describe('when submitting an empty form', () => {
      it('should render validation errors', () => {
        ...
        const expectedMessage = ERROR_MESSAGES[CONSTANTS.FIELDS.TRIED_PRIVATE_COVER];

        partials.errorSummaryListItems().first().invoke('text').then((text) => {
          expect(text.trim()).equal(expectedMessage);
        });

        triedToObtainCoverPage[CONSTANTS.FIELDS.TRIED_PRIVATE_COVER].errorMessage().invoke('text').then((text) => {
    ...
    describe('when submitting the answer as `yes`', () => {
      it(`should redirect to ${CONSTANTS.ROUTES.FINAL_DESTINATION}`, () => {
        triedToObtainCoverPage[CONSTANTS.FIELDS.TRIED_PRIVATE_COVER].yes().click();
        triedToObtainCoverPage.submitButton().click();
    ...
    describe('when submitting the answer as `no`', () => {
      it(`should redirect to ${CONSTANTS.ROUTES.FINAL_DESTINATION}`, () => {
        triedToObtainCoverPage[CONSTANTS.FIELDS.TRIED_PRIVATE_COVER].no().click();
        triedToObtainCoverPage.submitButton().click();
