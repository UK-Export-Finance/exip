...
context('What percentage of your export is UK content page', () => {
  ...
  describe('with valid login', () => {
    ...
    it('renders a label and hint', () => {
      ...
      const input = CONSTANTS.FIELD_IDSUK_CONTENT_PERCENTAGE;
    ...
    describe('form submission', () => {
      describe('when submitting an empty form', () => {
        it('should render validation errors', () => {
          ...
          const expectedMessage = ERROR_MESSAGES[CONSTANTS.FIELD_IDSUK_CONTENT_PERCENTAGE].IS_EMPTY;
      ...
      describe('when submitting the answer as a word (instead of number)', () => {
        it('should render validation errors', () => {
          ...
          const expectedMessage = ERROR_MESSAGES[CONSTANTS.FIELD_IDSUK_CONTENT_PERCENTAGE].NOT_A_NUMBER;
      ...
      describe('when submitting the answer as a number lower than 0', () => {
        it('should render validation errors', () => {
          ...
          const expectedMessage = ERROR_MESSAGES[CONSTANTS.FIELD_IDSUK_CONTENT_PERCENTAGE].BELOW_MINIMUM;
      ...
      describe('when submitting the answer as a number higher than 100', () => {
        it('should render validation errors', () => {
          ...
          const expectedMessage = ERROR_MESSAGES[CONSTANTS.FIELD_IDSUK_CONTENT_PERCENTAGE].ABOVE_MAXIMUM;
