...
context('Exporter location page - as an exporter, I want to check if my company can get UKEF issue export insurance cover', () => {
  ...
  it('renders yes and no radio buttons', () => {
    const yesRadio = companyBasedPage[FIELD_IDS.VALID_EXPORTER_LOCATION].yes();
    ...
    const noRadio = companyBasedPage[FIELD_IDS.VALID_EXPORTER_LOCATION].no();
  ...
  describe('form submission', () => {
    describe('when submitting an empty form', () => {
      it('should render validation errors', () => {
        ...
        companyBasedPage[FIELD_IDS.VALID_EXPORTER_LOCATION].errorMessage().invoke('text').then((text) => {
      ...
      it('should focus on input when clicking summary error message', () => {
        ...
        companyBasedPage[FIELD_IDS.VALID_EXPORTER_LOCATION].yesInput().should('have.focus');
      });
    });

    describe('when submitting the answer as `yes`', () => {
      it(`should redirect to ${ROUTES.QUOTE.HAS_MINIMUM_UK_GOODS_OR_SERVICES}`, () => {
        companyBasedPage[FIELD_IDS.VALID_EXPORTER_LOCATION].yes().click();
        companyBasedPage.submitButton().click();
