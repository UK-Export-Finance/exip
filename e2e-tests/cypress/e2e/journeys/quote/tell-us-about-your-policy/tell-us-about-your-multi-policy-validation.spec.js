...
context('Tell us about the multiple policy you need - form validation', () => {
  ...
  describe('when `max amount owed` has a non-numeric value', () => {
    it('should render a validation error', () => {
      cy.inputType(tellUsAboutYourPolicyPage[FIELD_IDS.MAX_AMOUNT_OWED].input(), 'a');
      submitButton().click();
  ...
  describe('when `max amount owed` is not a whole number', () => {
    it('should render a validation error', () => {
      cy.inputType(tellUsAboutYourPolicyPage[FIELD_IDS.MAX_AMOUNT_OWED].input(), '1234.56');
      submitButton().click();
  ...
  describe('when `max amount owed` has a value less than the minimum', () => {
    it('should render a validation error', () => {
      cy.inputType(tellUsAboutYourPolicyPage[FIELD_IDS.MAX_AMOUNT_OWED].input(), '0');
      submitButton().click();
  ...
  describe('with any validation error', () => {
    it('should render submitted values', () => {
      ...
      cy.inputType(tellUsAboutYourPolicyPage[FIELD_IDS.MAX_AMOUNT_OWED].input(), '10');
