...
const natureOfBusiness = {
  [GOODS_OR_SERVICES]: {
    ...
    errorMessage: () => cy.get(`[data-cy="${GOODS_OR_SERVICES}-error-message`),
  },
  [YEARS_EXPORTING]: {
